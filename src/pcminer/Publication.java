...
public final class Publication {
	...
	public Publication(String title, ConferenceInstance conferenceInstance, String pages, List<Author> authors, String session) {
		this.title = title;
	...
	public String toString() {
		return "Publication [" + title + " " + authors + " "
				+ conferenceInstance + " " + pages + ", session="
				+ session +  "]";
	}
